    ...
    public class ExceptionMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            catch(Exception ex)
            {
                ...
                var option = new JsonSerializerOptions{ PropertyNamingPolicy = JsonNamingPolicy.CamelCase }; //// conversion to JSON & api controllers do this by default but since its a midleware it has to mentioned seperatly
